                    ...
                    <div>
                        ...
                        <div class="card shadow" style="color: #4B515D; border-radius: 35px; width: 300px">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex">
                                    <h6 class="flex-grow-1">{{$selectedRoom->name}}</h6>
                                </div>
                    ...
                    <div>
                        ...
                        <div class="card shadow" style="color: #4B515D; border-radius: 35px; width: 300px">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex">
                                    <h6 class="flex-grow-1">{{$selectedRoom->updated_at}}</h6>
                                </div>

                                <div class="d-flex flex-column text-center mt-2 mb-4">
                                    <h6 class="display-1 mb-1 font-weight-bold" style="color: #1C2331; font-size: 4rem">
                                        {{$selectedRoom->energyStatus}} kWh </h6>
                                </div>
                    ...
                    <div>
                        <div class="card shadow" style="color: #4B515D; border-radius: 35px; width: 300px">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex flex-column text-center mt-2 mb-4">
                                    <h6 class="display-1 mb-1 font-weight-bold" style="color: #1C2331;"> {{$selectedRoom->co2}} </h6>
                                </div>
